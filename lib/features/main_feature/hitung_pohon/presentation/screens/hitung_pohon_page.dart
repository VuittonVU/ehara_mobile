...
class _HitungPohonPageState extends ConsumerState<HitungPohonPage> {
  ...
  Future<void> _upload() async {
    ...
    final job = await ref.read(hitungPohonControllerProvider.notifier).uploadAndWait(_selectedFile!);
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Catatan:', style: AppTextStyles.semiBold(fontSize: 13, color: const Color(0xFFE0A100))),
                      ...
                      Text(
                        ...
                        style: AppTextStyles.regular(fontSize: 13, color: AppColors.textPrimary.withOpacity(0.72)).copyWith(height: 1.45),
                      ),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(color: AppColors.textPrimary.withOpacity(0.35)),
                          ),
                          child: _selectedFile == null
                              ? Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Icon(Icons.cloud_upload_outlined, size: 64, color: AppColors.textPrimary.withOpacity(0.42)),
                                    const SizedBox(height: 8),
                                    Text(
                                      'Unggah File',
                                      textAlign: TextAlign.center,
                                      style: AppTextStyles.medium(fontSize: 16, color: AppColors.textPrimary.withOpacity(0.55)),
                                    ),
                                  ],
                                )
                              : Padding(
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text('TIF', style: AppTextStyles.bold(fontSize: 11, color: AppColors.primary)),
                                          ],
                                        ),
                                      ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              style: AppTextStyles.semiBold(fontSize: 14, color: AppColors.textPrimary),
                                            ),
                                            const SizedBox(height: 6),
                                            Text(
                                              _formatFileSize(_selectedFileSize),
                                              style: AppTextStyles.regular(fontSize: 12, color: AppColors.textPrimary.withOpacity(0.62)),
                                            ),
                                            const SizedBox(height: 8),
                                            Row(
                                              children: [
                                                ...
                                                Text('File berhasil dipilih', style: AppTextStyles.medium(fontSize: 12, color: AppColors.primary)),
                                              ],
                                            ),
                                          ],
                                        ),
                      ...
                      Text('File yang dipilih harus berformat .tif/.tiff', style: AppTextStyles.regular(fontSize: 12, color: AppColors.textPrimary.withOpacity(0.7))),
                      if (state.isUploading) ...[
                        const SizedBox(height: 18),
                        ClipRRect(
                          borderRadius: BorderRadius.circular(99),
                          child: LinearProgressIndicator(
                            value: currentJob == null ? null : (currentJob.progress.clamp(0, 100) / 100),
                            minHeight: 8,
                        ...
                        Text(
                          ...
                          style: AppTextStyles.medium(fontSize: 12, color: AppColors.primary),
                        ),
                      ],
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: state.isUploading
                              ...
                              : Text('Upload dan Lanjutkan', style: AppTextStyles.semiBold(fontSize: 15, color: Colors.white)),
                        ),
                      ),
                    ],
                  ),
